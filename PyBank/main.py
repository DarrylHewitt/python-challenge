...
with open(csvpath) as csvfile: # Open and read the csv file
    ...
    results_folder = "C:\\Users\\dhewi\\OneDrive\\Desktop\\Bootcamp\\Week_3\\Week_3_assignment\\python-challenge\\PyBank\\Analysis"
    results_path = os.path.join(results_folder, "financial_analysis.txt")
    ...
    with open(results_path, "w") as file:
        ...
        file.write(f"Total Months: {len(mths)}\n")
        file.write(f"Total: ${net_profit_loss}\n")
        print(f"Total Months: {len(mths)}")
        ...
        file.write(f"Average change: ${avg_mthly_change_rounded}\n")
        ...
        file.write(f"Greatest Increase in Profits: {max_mth} (${max_inc})\n")
        ...
        file.write(f"Greatest Decrease in Profits: {min_mon} (${max_dec})\n")
